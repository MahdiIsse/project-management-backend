    ...
    public partial class CompleteDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssigneeProjectTask", x => new { x.AssigneesId, x.TasksId });
                    table.ForeignKey(
                        name: "FK_AssigneeProjectTask_Assignees_AssigneesId",
                        column: x => x.AssigneesId,
                        principalTable: "Assignees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssigneeProjectTask_Tasks_TasksId",
                        column: x => x.TasksId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssigneeProjectTask_TasksId",
                table: "AssigneeProjectTask",
                column: "TasksId");
